...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div>
        <a href="{{ route('suppliers.show', $supplier->id) }}" class="btn btn-info btn-rounded">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Optional: Additional information about this supplier</small>
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Inactive suppliers won't be displayed in product forms</small>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <div class="card bg-light">
                        <div class="card-body">
                            <h6 class="font-weight-bold">Supplier Statistics</h6>
                            <hr>
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span>
                                    @if($supplier->last_order_date)
                                        {{ \Carbon\Carbon::parse($supplier->last_order_date)->format('M d, Y') }}
                                    @else
                                        N/A
                                    @endif
                                </span>
