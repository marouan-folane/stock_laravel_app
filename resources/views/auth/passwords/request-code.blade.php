        ...
        <div class="login-form-section">
            <div class="login-card">
                <div class="login-header">
                    ...
                    <p style="color: #6b7280; margin: 0;">Enter your email to receive a verification code</p>
                </div>
                ...
                <div class="login-form-content">
                    ...
                    <form method="POST" action="{{ route('password.code.send') }}">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-envelope" style="margin-right: 0.5rem;"></i> {{ __('Send Verification Code') }}
                        </button>
